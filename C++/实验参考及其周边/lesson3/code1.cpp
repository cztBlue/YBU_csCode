...
int main()
{
  int data_i[10] = {1, 2, 3, 4, 5, 8, 7, 9, 56, 3};
  double data_d[10] = {1.1, 15.8, 96.554, 96.4, 78.4, 52.6, 36.4, 58.66, 94.6, 71.3};
  float data_f[10] = {1.23, 5.65, 896.5, 56.4, 8963.8, 55.6, 36.4, 58.66, 94.6, 71.3};
  arrOperate op;
